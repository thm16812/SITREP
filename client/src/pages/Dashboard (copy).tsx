...
export default function Dashboard() {
  ...
  const [mapCenter] = useState<[number, number]>([36.985, -86.455]);
      ...
      <div className="absolute top-0 left-0 right-0 h-10 z-[600] flex items-center justify-center gap-2 md:gap-6 px-2 md:px-4 pointer-events-none">
        <div className="bg-background/80 backdrop-blur-md border border-border/50 rounded-full px-3 md:px-6 py-1 shadow-xl flex items-center gap-3 md:gap-6 pointer-events-auto scale-90 md:scale-100">
          <div className="flex items-center gap-1 md:gap-2">
            <AlertTriangle
              className={`w-3 md:w-3.5 h-3 md:h-3.5 ${warningsCount > 0 ? "text-destructive animate-pulse" : "text-muted-foreground"}`}
            />
            <span className="text-[8px] md:text-[10px] font-black uppercase tracking-widest hidden sm:inline">
              Warnings:
            </span>
            <span
              className={`text-[10px] md:text-xs font-mono-tech font-bold ${warningsCount > 0 ? "text-destructive" : "text-muted-foreground"}`}
            >
              {warningsCount}
            </span>
          </div>
          ...
          <div className="flex items-center gap-1 md:gap-2">
            <ShieldAlert
              className={`w-3 md:w-3.5 h-3 md:h-3.5 ${watchesCount > 0 ? "text-[hsl(var(--warning))]" : "text-muted-foreground"}`}
            />
            <span className="text-[8px] md:text-[10px] font-black uppercase tracking-widest hidden sm:inline">
              Watches:
            </span>
            <span
              className={`text-[10px] md:text-xs font-mono-tech font-bold ${watchesCount > 0 ? "text-[hsl(var(--warning))]" : "text-muted-foreground"}`}
            >
              {watchesCount}
            </span>
          </div>
          ...
          <div className="flex items-center gap-1 md:gap-2">
            <Info
              className={`w-3 md:w-3.5 h-3 md:h-3.5 ${advisoriesCount > 0 ? "text-primary" : "text-muted-foreground"}`}
            />
            <span className="text-[8px] md:text-[10px] font-black uppercase tracking-widest hidden sm:inline">
              Advisories:
            </span>
            <span
              className={`text-[10px] md:text-xs font-mono-tech font-bold ${advisoriesCount > 0 ? "text-primary" : "text-muted-foreground"}`}
            >
              {advisoriesCount}
            </span>
          </div>
      ...
      <aside
        className={`${
          sidebarCollapsed
            ...
            : "w-full md:w-[380px] p-4 border-r"
        ...
        {!sidebarCollapsed && (
          <>
            ...
            >
              ...
              <TabsContent
                value="layers"
                className="flex-1 mt-4 space-y-4 overflow-y-auto pr-2 pb-6"
              >
                {/* Overlay Controls */}
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[10px] font-mono-tech font-bold text-primary">
                    ...
                    <div className="space-y-2 pt-2 border-t border-border/30">
                      <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(c) => setShowSatellite(!!c)}
                          />
                          <Label
                            htmlFor="satellite"
                            className="text-[10px] font-bold uppercase cursor-pointer"
                      ...
                      <div className="space-y-3">
                        <Select
                          value={satelliteBand}
                          onValueChange={setSatelliteBand}
                        ...
                        >
                          ...
                          <SelectContent className="z-[800]">
                            <SelectItem value="ch01">
                              Band 01: Visible (Blue)
                            </SelectItem>
                            <SelectItem value="ch02">
                              Band 02: Visible (Red 0.64µm)
                            </SelectItem>
                            <SelectItem value="ch03">
                              Band 03: Veggie (NIR)
                            </SelectItem>
                            <SelectItem value="ch04">
                              Band 04: Cirrus (NIR)
                            </SelectItem>
                            <SelectItem value="ch05">
                              Band 05: Snow/Ice (NIR)
                            </SelectItem>
                            <SelectItem value="ch06">
                              Band 06: Particle Size (NIR)
                            </SelectItem>
                            <SelectItem value="ch07">
                              Band 07: Shortwave IR
                            </SelectItem>
                            <SelectItem value="ch08">
                              Band 08: Upper-level WV (6.2µm)
                            </SelectItem>
                            <SelectItem value="ch09">
                              Band 09: Mid-level WV
                            </SelectItem>
                            <SelectItem value="ch10">
                              Band 10: Lower-level WV
                            </SelectItem>
                            <SelectItem value="ch11">
                              Band 11: Cloud Top Phase
                            </SelectItem>
                            <SelectItem value="ch12">Band 12: Ozone</SelectItem>
                            <SelectItem value="ch13">
                              Band 13: Clean (LWIR)
                            </SelectItem>
                            <SelectItem value="ch14">
                              Band 14: Long-wave IR (11.2µm)
                            </SelectItem>
                            <SelectItem value="ch15">
                              Band 15: Dirty (LWIR)
                            </SelectItem>
                            <SelectItem value="ch16">
                              Band 16: CO2 (LWIR)
                            </SelectItem>
                          </SelectContent>
                        </Select>
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="day1"
                        checked={showDay1}
                        onCheckedChange={(c) => setShowDay1(!!c)}
                      />
                      <Label
                        htmlFor="day1"
                        className="text-[10px] font-bold uppercase cursor-pointer"
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="day2"
                        checked={showDay2}
                        onCheckedChange={(c) => setShowDay2(!!c)}
                      />
                      <Label
                        htmlFor="day2"
                        className="text-[10px] font-bold uppercase cursor-pointer"
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="day3"
                        checked={showDay3}
                        onCheckedChange={(c) => setShowDay3(!!c)}
                      />
                      <Label
                        htmlFor="day3"
                        className="text-[10px] font-bold uppercase cursor-pointer"
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="tornado"
                        checked={showTornado}
                        onCheckedChange={(c) => setShowTornado(!!c)}
                      />
                      <Label
                        htmlFor="tornado"
                        className="text-[10px] font-bold uppercase cursor-pointer text-destructive"
                      >
                        Tornado
                      </Label>
                    </div>
              ...
              <TabsContent
                value="afd"
                className="flex-1 mt-4 overflow-hidden flex flex-col gap-4"
              >
